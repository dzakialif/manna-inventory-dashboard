            ...
            data: [
                {
                    id: 1,
                    tanggal: "2026-04-03",
                    no_invoice: "OUT-INV-202604-0001",
                    tipe: "Penjualan",
                    total_item: 12,
                ...
                },
                {
                    id: 2,
                    tanggal: "2026-04-05",
                    no_invoice: "OUT-INV-202604-0002",
                    tipe: "Penjualan",
                    total_item: 7,
                ...
                },
                {
                    id: 3,
                    tanggal: "2026-04-07",
                    no_invoice: "OUT-INV-202604-0003",
                    tipe: "Transfer Cabang",
                    total_item: 20,
                ...
                },
                {
                    id: 4,
                    tanggal: "2026-04-09",
                    no_invoice: "OUT-INV-202604-0004",
                    tipe: "Penjualan",
                    total_item: 5,
                ...
                },
                {
                    id: 5,
                    tanggal: "2026-04-12",
                    no_invoice: "OUT-INV-202604-0005",
                ...
                },
                {
                    id: 6,
                    tanggal: "2026-04-15",
                    no_invoice: "OUT-INV-202604-0006",
                    tipe: "Penjualan",
                    total_item: 18,
                ...
                },
                {
                    id: 7,
                    tanggal: "2026-04-18",
                    no_invoice: "OUT-INV-202604-0007",
                    tipe: "Transfer Cabang",
                    total_item: 9,
                ...
                },
                {
                    id: 8,
                    tanggal: "2026-04-22",
                    no_invoice: "OUT-INV-202604-0008",
                    tipe: "Penjualan",
                    total_item: 4,
...
<template>
    <div class="card">
        ...
        >
            ...
            >
                <template #body="{ data }">{{ data.total_transaksi }}</template>
                <template #filter="{ filterModel, filterCallback }">
                    <input
                        v-model="filterModel.value"
                        type="text"
